...
public class ModFoodProperties {
    ...
    public static final FoodProperties MOROCCAN_MINT_TEA = new FoodProperties.Builder()
            .alwaysEdible()
            .nutrition(2)
            .saturationModifier(0.25f)
            .build();
    ...
    public static final FoodProperties MINER_LUNG_CANDY = new FoodProperties.Builder()
            .nutrition(2)
            .saturationModifier(0.25f)
            .build();
    public static final Consumable MINER_LUNG_CANDY_CONSUMABLE = Consumables.defaultFood()
